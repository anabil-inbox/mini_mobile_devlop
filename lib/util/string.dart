...
String? txtBestSelling = "Best Selling";
String? txtSeeAll = "See all";
String? txtExplore = "Explore";
String? txtCart = "Cart";
String? txtProfile = "Profile";
String? txtCategoryResult = "Men";

//todo this for cart page
String? txtCHECKOUT = "CHECKOUT";
String? txtTOTAL = "TOTAL";

//todo this for profile page
String? txtEditProfile = "Edit Profile";
String? txtShippingAddress = "Shipping Address";
String? txtOrderHistory = "Order History";
String? txtCards = "Cards";
