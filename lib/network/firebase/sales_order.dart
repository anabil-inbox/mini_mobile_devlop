...
class SalesOrder {
  ...
  factory SalesOrder.fromJson(Map<String, dynamic> json) => SalesOrder(
        ...
        contentStatus: json["content_status"]  == null ? null: json["content_status"],
        ...
        latituide: json["latitude"]  == null ? null: json["latitude"],
        orderType: json["order_type"]  == null ? null: json["order_type"],
        totalPrice: json["total_price"]  == null ? null: json["total_price"],
        taskStatus: json["task_status"]  == null ? null: json["task_status"].toString().toLowerCase(),
        ...
        deliveryDate: DateTime.parse(json["delivery_date"]  == null ? null: json["delivery_date"]),
        status: json["status"]  == null ? null: json["status"],
        totalBoxes: json["total_boxes"]  == null ? null: json["total_boxes"],
        totalReceived: json["total_received"]  == null ? null: json["total_received"],
        orderDoc: json["order_doc"]  == null ? null: json["order_doc"],
        buildingNo: json["building_no"]  == null ? null: json["building_no"],
        unitNo: json["unit_no"]  == null ? null: json["unit_no"],
        street: json["street"]  == null ? null: json["street"],
        fromTime: json["from_time"]  == null ? null: json["from_time"].toString().split(".")[0],
        toTime: json["to_time"]  == null ? null: json["to_time"].toString().split(".")[0],
        paymentMethod: json["payment_method"]  == null ? null: json["payment_method"],
        boxes:json["boxes"] == null ? null: List<BoxModel>.from(json["boxes"].map((x) => BoxModel.fromJson(x))),
        orderItems: json["order_items"] == null ? null:List<OrderItem>.from(
