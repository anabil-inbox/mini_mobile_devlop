      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
              color: colorTextWhite, borderRadius: BorderRadius.circular(6)),
          child: Stack(
            children: [
              ...
              PositionedDirectional(
                top: sizeH54,
                start: sizeH54,
                child: Text("${address.streat} ${address.zone} ${address.buildingNo}"),
              ),
              PositionedDirectional(
                top: sizeH12,
                end: sizeH12,
                  ...
                  children: [
                    InkWell(
                      onTap: (){
                        ...
                        profileViewModle.userAddress.removeWhere((element) => element.id == address.id);
