...
class _EditAddressScreenState extends State<EditAddressScreen> {
  ...
  void initState() {
    ...
    profileViewModle.tdExtraDetailesEdit.text = widget.address.extraDetails ?? "";
    profileViewModle.tdLocationEdit.text = widget.address.zone ?? "" + " " + widget.address.streat!;
    ...
    profileViewModle.isAccepteDefoltLocation = widget.address.isPrimaryAddress == 1 ;
  }
                    ...
                    return PrimaryButton(
                        ...
                        onClicked: () {
                          if (_formKey.currentState!.validate()) {
                              ...
                              extraDetails: controller.tdExtraDetailesEdit.text,
