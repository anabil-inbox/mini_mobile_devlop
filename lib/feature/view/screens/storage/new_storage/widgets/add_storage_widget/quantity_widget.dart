                ...
                child: Stack(
                  children: [
                        ...
                        child: GetBuilder<StorageViewModel>(
                          ...
                          builder: (builder) {
                            return IconButton(
                              ...
                              icon: SvgPicture.asset("assets/svgs/circle_mines_orange.svg" , width: sizeH24,),//circle_mines.svg
                              onPressed: () {
                                mineassingFunction();
                    ...
                    child: GetBuilder<StorageViewModel>(
                      ...
                      builder: (value) {
                        return IconButton(
                          icon: SvgPicture.asset("assets/svgs/add_icons_orange.svg" , width: sizeH24,),/*circle_add*/
                          onPressed: () {
                            increasingFunction();
