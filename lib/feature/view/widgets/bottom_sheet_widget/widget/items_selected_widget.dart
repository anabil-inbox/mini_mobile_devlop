...
class ItemsSelectedWidget extends StatelessWidget {
    ...
    children: [
      ...
      SizedBox(
        ...
        child: TextButton(
          ...
          child: SvgPicture.asset("assets/svgs/storage_check_active.svg"),
        ),
      ),
      SizedBox(
        width: sizeW10,
      ...
      Expanded(
        child:  CustomTextView(
          ...
          textStyle: textStyleNormal()?.copyWith(color: colorBlack,height: 1),
  ...
  Widget get lvImageSelected => Column(
    ...
    children: [
      if(boxItem?.itemGallery != null && boxItem?.itemGallery?.length != 0)...[
      CustomTextView(
        txt: "${tr.select_item_photo}",
      ...
      SizedBox(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return ImageSelectedItem(itemGallery:boxItem?.itemGallery?[index]);
          },
        ),
      ),
      ]
